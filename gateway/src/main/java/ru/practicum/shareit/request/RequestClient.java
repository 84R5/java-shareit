...
public class RequestClient extends BaseClient {
    ...
    public ResponseEntity<Object> getAllRequestsOthersUser(Long requesterId, Integer from, Integer size) {
    ...
    public ResponseEntity<Object> create(Long userId, RequestInputDto itemRequestInputDto) {
